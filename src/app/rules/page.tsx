    ...
    <article className="prose-sm mx-auto max-w-3xl space-y-6">
      ...
      <section className="card p-5">
        ...
        <p className="mt-2 text-sm text-fgm">
          Засчитывается только самый высокий достигнутый бонус: полная неделя даёт +10 🎃, а не 2+5+10.
          После 7 дней или после пропуска отсчёт начинается заново.
        </p>
      </section>
      ...
      <section className="card p-5">
        ...
        <p className="mt-2 text-sm text-fgm">
          ...
          (9 заданий, максимум +27 🎃). День с заданием бинго считается активным и продлевает стрик.
        </p>
      ...
      <section className="card p-5">
        ...
        <ul className="mt-2 space-y-1">
          ...
          <li>📸 <b>«Амбассадор Осени»</b> — автор самых атмосферных фото/видео. Выбирается голосованием участников в финале: один голос, за себя нельзя.</li>
        </ul>
      </section>
    </article>
  );
